'''
OK, so here's silly thing I made for no reason other than pure curiosity. Could a 
python dict be used as a very rudimentary linked list like creature. Answer: yes it can.
Of course it's completely useless tbh. Since a dict is a collection of key/value pairs,
